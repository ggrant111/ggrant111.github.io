function generateXML() {
    ...
    const postalCode =
      document.getElementById("postalCode").value || defaultValues.postalCode;
    const country =
    ...
    try {
      ...
      alert(
        "There was a problem with the selected vehicle data. Please try again."
      );
  ...
  // Correctly select the element by ID and add an event listener
